...
u8 = User.create!(email: 'test8@testmail.com', password: '12345678', name: 'Tim Cook', username: 'AppleCEO', bio: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', hometown: 'Capurtino')

u9 = User.create!(email: 'test9@testmail.com', password: '12345678', name: 'Eric Schmidt', username: 'AndroidUser#1', bio: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', hometown: 'Mountain View')

u10 = User.create!(email: 'test10@testmail.com', password: '12345678', name: 'Rolf Harris', username: 'prisonbreaker', bio: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', hometown: 'Perth')

u11 = User.create!(email: 'iferunsswe@gmail.com', password: '12345678', name: 'Ife Runsewe', username: 'pizzahand', bio: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', hometown: 'London')

u12 = User.create!(email: 'nina.sridhar.1@gmail.com', password: '12345678', name: 'Nina Sridhar', username: 'rubygenius', bio: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', hometown: 'London')
...
c1.photos = [p24, p17, p2]
c2.photos = [p4, p15, p13]
c3.photos = [p20, p2]
c4.photos = [p5, p25, p12]
c5.photos = [p21, p8]
c6.photos = [p7, p12, p27]
c7.photos = [p9, p19, p8]
c8.photos = [p10, p13]
c9.photos = [p14, p26]
c10.photos = [p25, p1, p5]
c11.photos = [p22, p12]
c12.photos = [p27, p32, p21]
c13.photos = [p28, p6, p17]
c14.photos = [p3, p24]
c15.photos = [p8, p12, p1]
c16.photos = [p22, p10]
c17.photos = [p5, p19, p7]
c18.photos = [p26, p13, p24]
c19.photos = [p7, p14, p32]
c20.photos = [p1, p17]